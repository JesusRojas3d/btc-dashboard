...
- Las contrase�as ahora deben ir en variables de entorno del backend.
- El archivo `data/profile-purchases.private.json` queda ignorado por Git para no exponer compras sensibles.
- Si el repo fue p�blico antes, conviene asumir que los secretos y compras antiguas ya pudieron ser vistos.
